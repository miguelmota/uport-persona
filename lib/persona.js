...
/** Class representing a uPort Registry. */
 class Registry {
      ...
      *  @param           {String}         [registryAddress='0xb9C1598e24650437a3055F7f66AC1820c419a679']      the uport-registry address to use.
      *  @return          {Object}         self
      */
      constructor (ipfs, web3Provider, registryAddress) {
      ...
      getProfiles(addresses) {
        return Promise.all(addresses.map(address => getProfile(address)))
      }
}
...
module.exports = { Registry, PublicPersona, Persona }
